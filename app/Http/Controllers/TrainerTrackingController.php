...
class TrainerTrackingController extends Controller
{
    ...
    public function checkin(Request $request): JsonResponse
    {
        ...
        $status['updated_at'] = now()->setTimezone(app()->bound('request.timezone') ? app('request.timezone') : config('coms.user_settings.defaults.timezone', 'Asia/Phnom_Penh'))->format('Y-m-d\TH:i:s.uP');
